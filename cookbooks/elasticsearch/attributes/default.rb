...
default[:elasticsearch][:sensu][:handler_red] = ['notification']
default[:elasticsearch][:sensu][:handler_orange] = ['notification']
default[:elasticsearch][:sensu][:handler_yellow] = ['notification']
